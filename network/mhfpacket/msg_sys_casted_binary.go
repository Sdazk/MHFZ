...
func (m *MsgSysCastedBinary) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgSysCastedBinary) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
