...
func (m *MsgMhfAddKouryouPoint) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfAddKouryouPoint) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
