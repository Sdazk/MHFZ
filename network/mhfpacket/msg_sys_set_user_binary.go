...
func (m *MsgSysSetUserBinary) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgSysSetUserBinary) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
