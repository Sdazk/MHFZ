...
func (m *MsgMhfSaveMezfesData) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfSaveMezfesData) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
