...
func (m *MsgMhfSavePartner) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfSavePartner) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
