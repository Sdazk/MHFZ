...
func (m *MsgSysUnreserveStage) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
	return nil
}

// Build builds a binary packet from the current data.
func (m *MsgSysUnreserveStage) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
