...
func (m *MsgMhfEnumerateRanking) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfEnumerateRanking) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
