...
func (m *MsgMhfAddUdTacticsPoint) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfAddUdTacticsPoint) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
