...
func (m *MsgMhfAcquireCafeItem) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfAcquireCafeItem) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
