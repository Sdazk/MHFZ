...
func (m *MsgMhfGetTenrouirai) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfGetTenrouirai) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
