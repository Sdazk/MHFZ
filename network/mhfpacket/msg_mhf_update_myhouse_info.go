...
func (m *MsgMhfUpdateMyhouseInfo) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfUpdateMyhouseInfo) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
