...
func (m *MsgMhfOperateGuildMember) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfOperateGuildMember) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
