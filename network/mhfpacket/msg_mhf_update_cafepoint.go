...
func (m *MsgMhfUpdateCafepoint) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfUpdateCafepoint) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
