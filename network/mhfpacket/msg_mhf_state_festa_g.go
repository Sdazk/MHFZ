...
func (m *MsgMhfStateFestaG) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfStateFestaG) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
