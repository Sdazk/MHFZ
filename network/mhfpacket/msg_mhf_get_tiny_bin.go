...
func (m *MsgMhfGetTinyBin) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfGetTinyBin) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
