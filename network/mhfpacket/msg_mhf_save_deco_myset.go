...
func (m *MsgMhfSaveDecoMyset) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfSaveDecoMyset) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
