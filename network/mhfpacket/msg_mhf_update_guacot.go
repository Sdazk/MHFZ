...
func (m *MsgMhfUpdateGuacot) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfUpdateGuacot) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
