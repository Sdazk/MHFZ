...
func (m *MsgMhfGetMyhouseInfo) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfGetMyhouseInfo) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
