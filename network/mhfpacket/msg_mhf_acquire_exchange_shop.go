...
func (m *MsgMhfAcquireExchangeShop) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfAcquireExchangeShop) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
