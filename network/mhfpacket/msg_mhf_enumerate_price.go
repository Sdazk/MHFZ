...
func (m *MsgMhfEnumeratePrice) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfEnumeratePrice) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
