...
func (m *MsgMhfReleaseEvent) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfReleaseEvent) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
