...
func (m *MsgMhfGetRengokuBinary) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfGetRengokuBinary) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
