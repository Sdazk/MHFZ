...
func (m *MsgMhfReadMercenaryW) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfReadMercenaryW) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
