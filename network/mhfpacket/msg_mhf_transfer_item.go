...
func (m *MsgMhfTransferItem) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfTransferItem) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
