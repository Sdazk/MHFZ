...
func (m *MsgMhfUpdateEquipSkinHist) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfUpdateEquipSkinHist) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
