...
func (m *MsgMhfAcquireGuildAdventure) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfAcquireGuildAdventure) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
