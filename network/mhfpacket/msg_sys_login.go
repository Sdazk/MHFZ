...
func (m *MsgSysLogin) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgSysLogin) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
