...
func (m *MsgSysCreateSemaphore) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgSysCreateSemaphore) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
