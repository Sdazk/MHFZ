...
func (m *MsgSysSetStagePass) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
	m.Unk0 = bf.ReadUint8()
...
func (m *MsgSysSetStagePass) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
