...
func (m *MsgSysEnumerateClient) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgSysEnumerateClient) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
