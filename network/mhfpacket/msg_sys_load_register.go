...
func (m *MsgSysLoadRegister) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgSysLoadRegister) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
