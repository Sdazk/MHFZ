...
func (m *MsgMhfSetEnhancedMinidata) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfSetEnhancedMinidata) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
