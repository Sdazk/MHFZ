...
func (m *MsgSysUnlockStage) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
	m.Unk0 = bf.ReadUint16()
	return nil
}

// Build builds a binary packet from the current data.
func (m *MsgSysUnlockStage) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
