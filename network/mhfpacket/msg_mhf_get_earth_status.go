...
func (m *MsgMhfGetEarthStatus) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfGetEarthStatus) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
