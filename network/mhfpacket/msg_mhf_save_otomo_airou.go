...
func (m *MsgMhfSaveOtomoAirou) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfSaveOtomoAirou) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
