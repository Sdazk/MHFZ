...
func (m *MsgMhfGetEarthValue) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfGetEarthValue) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
