...
func (m *MsgMhfAcquireItem) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfAcquireItem) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
