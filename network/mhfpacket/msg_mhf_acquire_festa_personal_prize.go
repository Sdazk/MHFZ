...
func (m *MsgMhfAcquireFestaPersonalPrize) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfAcquireFestaPersonalPrize) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
