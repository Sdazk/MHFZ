...
func (m *MsgSysPositionObject) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgSysPositionObject) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
