...
func (m *MsgSysIssueLogkey) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgSysIssueLogkey) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
