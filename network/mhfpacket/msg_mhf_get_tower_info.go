...
func (m *MsgMhfGetTowerInfo) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfGetTowerInfo) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
