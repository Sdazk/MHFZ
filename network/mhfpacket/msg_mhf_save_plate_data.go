...
func (m *MsgMhfSavePlateData) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfSavePlateData) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
