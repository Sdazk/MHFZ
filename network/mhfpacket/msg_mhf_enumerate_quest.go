...
func (m *MsgMhfEnumerateQuest) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfEnumerateQuest) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
