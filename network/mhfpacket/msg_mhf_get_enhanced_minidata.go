...
func (m *MsgMhfGetEnhancedMinidata) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfGetEnhancedMinidata) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
