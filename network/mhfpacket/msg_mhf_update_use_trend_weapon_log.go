...
func (m *MsgMhfUpdateUseTrendWeaponLog) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfUpdateUseTrendWeaponLog) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
