...
func (m *MsgMhfGetSeibattle) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfGetSeibattle) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
