...
func (m *MsgSysSetObjectBinary) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgSysSetObjectBinary) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
