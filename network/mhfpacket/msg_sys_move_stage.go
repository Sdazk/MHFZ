...
func (m *MsgSysMoveStage) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgSysMoveStage) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
