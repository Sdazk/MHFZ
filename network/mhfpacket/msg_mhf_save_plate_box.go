...
func (m *MsgMhfSavePlateBox) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfSavePlateBox) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
