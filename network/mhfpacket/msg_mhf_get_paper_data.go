...
func (m *MsgMhfGetPaperData) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfGetPaperData) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
