...
func (m *MsgSysCreateStage) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgSysCreateStage) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
