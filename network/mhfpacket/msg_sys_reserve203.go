...
func (m *MsgSysReserve203) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgSysReserve203) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
