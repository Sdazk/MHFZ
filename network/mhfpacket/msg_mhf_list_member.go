...
func (m *MsgMhfListMember) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfListMember) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
