...
func (m *MsgMhfUpdateEtcPoint) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfUpdateEtcPoint) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
