...
func (m *MsgSysRecordLog) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgSysRecordLog) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
