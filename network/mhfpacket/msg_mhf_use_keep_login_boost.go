...
func (m *MsgMhfUseKeepLoginBoost) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfUseKeepLoginBoost) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
