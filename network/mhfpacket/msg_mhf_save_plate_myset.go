...
func (m *MsgMhfSavePlateMyset) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfSavePlateMyset) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
