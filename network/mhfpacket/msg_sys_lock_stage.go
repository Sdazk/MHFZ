...
func (m *MsgSysLockStage) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgSysLockStage) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
