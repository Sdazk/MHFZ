...
func (m *MsgMhfGetRengokuRankingRank) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
	m.AckHandle = bf.ReadUint32()
	return nil
}

// Build builds a binary packet from the current data.
func (m *MsgMhfGetRengokuRankingRank) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
