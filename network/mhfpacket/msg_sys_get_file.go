...
func (m *MsgSysGetFile) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgSysGetFile) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
