...
func (m *MsgSysGetUserBinary) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgSysGetUserBinary) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
