...
func (m *MsgMhfGetAdditionalBeatReward) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfGetAdditionalBeatReward) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
