...
func (m *MsgMhfArrangeGuildMember) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfArrangeGuildMember) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
