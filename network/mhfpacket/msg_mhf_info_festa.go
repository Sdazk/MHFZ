...
func (m *MsgMhfInfoFesta) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfInfoFesta) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
