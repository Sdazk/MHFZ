...
func (m *MsgSysSetStageBinary) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgSysSetStageBinary) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
