...
func (m *MsgMhfAcquireGuildTresure) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfAcquireGuildTresure) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
