...
func (m *MsgMhfEnumerateEvent) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfEnumerateEvent) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
