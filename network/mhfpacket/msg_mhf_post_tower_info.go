...
func (m *MsgMhfPostTowerInfo) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfPostTowerInfo) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
