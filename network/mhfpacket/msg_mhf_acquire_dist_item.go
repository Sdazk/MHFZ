...
func (m *MsgMhfAcquireDistItem) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfAcquireDistItem) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
