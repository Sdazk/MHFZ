...
func (m *MsgSysCreateObject) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgSysCreateObject) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
