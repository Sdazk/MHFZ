...
func (m *MsgMhfGetGuildWeeklyBonusMaster) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
	m.AckHandle = bf.ReadUint32()
	return nil
}

// Build builds a binary packet from the current data.
func (m *MsgMhfGetGuildWeeklyBonusMaster) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
