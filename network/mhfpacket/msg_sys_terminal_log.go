...
func (m *MsgSysTerminalLog) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgSysTerminalLog) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
