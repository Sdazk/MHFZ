...
func (m *MsgSysDeleteObject) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
	m.ObjID = bf.ReadUint32()
	return nil
}

// Build builds a binary packet from the current data.
func (m *MsgSysDeleteObject) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
