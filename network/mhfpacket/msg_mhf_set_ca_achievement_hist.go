...
func (m *MsgMhfSetCaAchievementHist) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfSetCaAchievementHist) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
