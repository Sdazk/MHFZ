...
func (m *MsgMhfAddAchievement) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
	m.Unk0 = bf.ReadUint8()
...
func (m *MsgMhfAddAchievement) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
