...
func (m *MsgMhfEnumerateShop) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfEnumerateShop) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
