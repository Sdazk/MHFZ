...
func (m *MsgSysCreateAcquireSemaphore) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgSysCreateAcquireSemaphore) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
