...
func (m *MsgMhfEnumerateGuild) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfEnumerateGuild) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
