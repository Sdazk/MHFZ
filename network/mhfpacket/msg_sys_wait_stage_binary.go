...
func (m *MsgSysWaitStageBinary) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgSysWaitStageBinary) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
