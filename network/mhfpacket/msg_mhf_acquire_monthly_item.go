...
type MsgMhfAcquireMonthlyItem struct {
	...
	Unk2      uint16
	Unk3      uint32
	Unk4      uint32 // Hardcoded 0 in binary
}
...
func (m *MsgMhfAcquireMonthlyItem) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfAcquireMonthlyItem) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
