...
func (m *MsgMhfCheckWeeklyStamp) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfCheckWeeklyStamp) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
