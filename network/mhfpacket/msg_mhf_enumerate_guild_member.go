...
func (m *MsgMhfEnumerateGuildMember) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfEnumerateGuildMember) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
