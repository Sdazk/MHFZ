...
func (m *MsgMhfOperateGuild) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfOperateGuild) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
