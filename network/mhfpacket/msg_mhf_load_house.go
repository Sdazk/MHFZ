...
func (m *MsgMhfLoadHouse) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfLoadHouse) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
