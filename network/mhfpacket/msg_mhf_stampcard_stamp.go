...
func (m *MsgMhfStampcardStamp) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfStampcardStamp) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
