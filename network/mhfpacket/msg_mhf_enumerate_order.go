...
func (m *MsgMhfEnumerateOrder) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfEnumerateOrder) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
