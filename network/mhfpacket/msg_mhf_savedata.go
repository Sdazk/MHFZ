...
func (m *MsgMhfSavedata) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfSavedata) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
