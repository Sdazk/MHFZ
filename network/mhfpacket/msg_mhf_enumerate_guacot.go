...
func (m *MsgMhfEnumerateGuacot) Parse(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
...
func (m *MsgMhfEnumerateGuacot) Build(bf *byteframe.ByteFrame, pctx *pctx.PacketContext) error {
